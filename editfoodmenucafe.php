...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="addfoodmenucafe.php">New Food</a>
            </li>
            <li class="nav-item">
	...
	<form method = "post" action = "editfood.php"  enctype = "multipart/form-data">
            ...
            <div class="control-group">
              ...
              <div class="controls">
               <input type = "text" name = "name" value="<?php echo $_GET['nama_makanan']; ?>">
              </div>
            </div>
             ...
             <div class="control-group">
              ...
              <div class="controls">
               <input type = "text" name = "price" value="<?php echo $_GET['harga_makanan']; ?>">
              </div>
            </div>
			...
			<div class="control-group">
              ...
              <div class="controls">
               <textarea rows="15" cols="60" name="deskripsi"><?php echo $_GET['deskripsi_makanan']; ?></textarea> <br>
              </div>
            </div>
